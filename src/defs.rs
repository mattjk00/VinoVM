...
pub mod funcs {
    pub const CALL:u64 =    0x4000_0000_0000_0000;
    pub const RETURN:u64 =  0x4100_0000_0000_0000;
}

pub mod math {
    pub const ADD:u64 =     0x5000_0000_0000_0000;
    pub const MULT:u64 =    0x5100_0000_0000_0000;
    pub const SUB:u64 =     0x5200_0000_0000_0000;
    pub const DIV:u64 =     0x5300_0000_0000_0000;
}
